...
const ReservationManagement = () => {
  ...
  const fetchReservations = async () => {
    try {
      ...
      const response = await axios.get(`${import.meta.env.VITE_API}/admin/restaurant/reservations`, {
        params: {
  ...
  const updateReservationStatus = async (reservationId, newStatus) => {
    try {
      await axios.put(`${import.meta.env.VITE_API}/admin/restaurant/reservations/status/${reservationId}`, {
        status: newStatus
      });
      fetchReservations();
    } catch (error) {
