...
const TableManagement = () => {
  ...
  const fetchTables = async () => {
    try {
      const response = await axios.get(`${import.meta.env.VITE_API}/admin/restaurant/tables`);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
        if (editingTable) {
            await axios.put(
                `${import.meta.env.VITE_API}/admin/restaurant/tables/${editingTable._id}`, 
                formData
            );
            ...
            await axios.post(
                `${import.meta.env.VITE_API}/admin/restaurant/tables`, 
                formData
            );
  ...
  const handleDelete = async (tableId) => {
    try {
        ...
        if (result.isConfirmed) {
            ...
            // Send delete request
            await axios.delete(`${import.meta.env.VITE_API}/admin/restaurant/tables/${tableId}`);
