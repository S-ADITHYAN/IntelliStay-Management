...
var rgb_default = function rgbGamma(y4) {
  ...
  function rgb2(start, end) {
    var r3 = color2((start = rgb(start)).r, (end = rgb(end)).r), g3 = color2(start.g, end.g), b3 = color2(start.b, end.b), opacity = nogamma(start.opacity, end.opacity);
    return function(t6) {
      start.r = r3(t6);
      start.g = g3(t6);
      start.b = b3(t6);
...
function rgbSpline(spline) {
  return function(colors) {
    var n3 = colors.length, r3 = new Array(n3), g3 = new Array(n3), b3 = new Array(n3), i3, color2;
    for (i3 = 0; i3 < n3; ++i3) {
...
function numberArray_default(a3, b3) {
  if (!b3) b3 = [];
  var n3 = a3 ? Math.min(b3.length, a3.length) : 0, c5 = b3.slice(), i3;
  return function(t6) {
    for (i3 = 0; i3 < n3; ++i3) c5[i3] = a3[i3] * (1 - t6) + b3[i3] * t6;
    return c5;
  };
}
...
function genericArray(a3, b3) {
  var nb = b3 ? b3.length : 0, na = a3 ? Math.min(nb, a3.length) : 0, x4 = new Array(na), c5 = new Array(nb), i3;
  for (i3 = 0; i3 < na; ++i3) x4[i3] = value_default(a3[i3], b3[i3]);
  for (; i3 < nb; ++i3) c5[i3] = b3[i3];
  return function(t6) {
    for (i3 = 0; i3 < na; ++i3) c5[i3] = x4[i3](t6);
    return c5;
  };
}
...
function value_default(a3, b3) {
  var t6 = typeof b3, c5;
  return b3 == null || t6 === "boolean" ? constant_default(b3) : (t6 === "number" ? number_default : t6 === "string" ? (c5 = color(b3)) ? (b3 = c5, rgb_default) : string_default : b3 instanceof color ? rgb_default : b3 instanceof Date ? date_default : isNumberArray(b3) ? numberArray_default : Array.isArray(b3) ? genericArray : typeof b3.valueOf !== "function" && typeof b3.toString !== "function" || isNaN(b3) ? object_default : number_default)(a3, b3);
}
...
function decompose_default(a3, b3, c5, d3, e6, f3) {
  var scaleX, scaleY, skewX;
  if (scaleX = Math.sqrt(a3 * a3 + b3 * b3)) a3 /= scaleX, b3 /= scaleX;
  if (skewX = a3 * c5 + b3 * d3) c5 -= a3 * skewX, d3 -= b3 * skewX;
  if (scaleY = Math.sqrt(c5 * c5 + d3 * d3)) c5 /= scaleY, d3 /= scaleY, skewX /= scaleY;
  if (a3 * d3 < b3 * c5) a3 = -a3, b3 = -b3, skewX = -skewX, scaleX = -scaleX;
  return {
    translateX: e6,
    translateY: f3,
...
function hsl2(hue2) {
  return function(start, end) {
    var h2 = hue2((start = hsl(start)).h, (end = hsl(end)).h), s4 = nogamma(start.s, end.s), l3 = nogamma(start.l, end.l), opacity = nogamma(start.opacity, end.opacity);
    return function(t6) {
      start.h = h2(t6);
      start.s = s4(t6);
      start.l = l3(t6);
...
function hcl2(hue2) {
  return function(start, end) {
    var h2 = hue2((start = hcl(start)).h, (end = hcl(end)).h), c5 = nogamma(start.c, end.c), l3 = nogamma(start.l, end.l), opacity = nogamma(start.opacity, end.opacity);
    return function(t6) {
      start.h = h2(t6);
      start.c = c5(t6);
      start.l = l3(t6);
...
function cubehelix2(hue2) {
  return function cubehelixGamma(y4) {
    ...
    function cubehelix3(start, end) {
      var h2 = hue2((start = cubehelix(start)).h, (end = cubehelix(end)).h), s4 = nogamma(start.s, end.s), l3 = nogamma(start.l, end.l), opacity = nogamma(start.opacity, end.opacity);
      return function(t6) {
        start.h = h2(t6);
        start.s = s4(t6);
        start.l = l3(Math.pow(t6, y4));
        start.opacity = opacity(t6);
        return start + "";
      };
    }
...
function blurf(radius) {
  ...
  return (T2, S2, start, stop, step) => {
    ...
    const s1 = s0 + step;
    for (let i3 = start, j3 = start + s0; i3 < j3; i3 += step) {
      sum3 += S2[Math.min(stop, i3)];
    }
    for (let i3 = start, j3 = stop; i3 <= j3; i3 += step) {
      sum3 += S2[Math.min(stop, i3 + s0)];
      T2[i3] = (sum3 + t6 * (S2[Math.max(start, i3 - s1)] + S2[Math.min(stop, i3 + s1)])) / w3;
      sum3 -= S2[Math.max(start, i3 - s0)];
    }
  };
}
function bluri(radius) {
  ...
  return (T2, S2, start, stop, step) => {
    ...
    for (let i3 = start, j3 = start + s4; i3 < j3; i3 += step) {
      sum3 += S2[Math.min(stop, i3)];
    }
    for (let i3 = start, j3 = stop; i3 <= j3; i3 += step) {
      sum3 += S2[Math.min(stop, i3 + s4)];
      T2[i3] = sum3 / w3;
      sum3 -= S2[Math.max(start, i3 - s4)];
    }
  };
}
...
function tickSpec(start, stop, count2) {
  ...
  if (i22 < i1 && 0.5 <= count2 && count2 < 2) return tickSpec(start, stop, count2 * 2);
  return [i1, i22, inc];
}
...
function range(start, stop, step) {
  ...
  var i3 = -1, n3 = Math.max(0, Math.ceil((stop - start) / step)) | 0, range2 = new Array(n3);
  while (++i3 < n3) {
...
function polymap(domain, range2, interpolate) {
  ...
  while (++i3 < j3) {
    ...
    r3[i3] = interpolate(range2[i3], range2[i3 + 1]);
  }
  return function(x4) {
...
function transformer() {
  ...
  function rescale() {
    ...
    if (clamp !== identity3) clamp = clamper(domain[0], domain[n3 - 1]);
...
function locale_default(locale3) {
  ...
  function newFormat(specifier) {
    ...
    function format2(value) {
      var valuePrefix = prefix, valueSuffix = suffix, i3, n3, c5;
      if (type === "c") {
        ...
        if (maybeSuffix) {
          ...
          while (++i3 < n3) {
            if (c5 = value.charCodeAt(i3), 48 > c5 || c5 > 57) {
              valueSuffix = (c5 === 46 ? decimal + value.slice(i3 + 1) : value.slice(i3)) + valueSuffix;
  ...
  function formatPrefix2(specifier, value) {
    var f3 = newFormat((specifier = formatSpecifier(specifier), specifier.type = "f", specifier)), e6 = Math.max(-8, Math.min(8, Math.floor(exponent_default(value) / 3))) * 3, k4 = Math.pow(10, -e6), prefix = prefixes[8 + e6 / 3];
...
function symlogish(transform) {
  ...
  scale.constant = function(_) {
    return arguments.length ? transform(transformSymlog(c5 = +_), transformSymexp(c5)) : c5;
  };
  return linearish(scale);
}
function symlog() {
...
function ticker(year2, month2, week, day2, hour2, minute2) {
  ...
  function tickInterval(start, stop, count2) {
    ...
    if (i3 === 0) return millisecond.every(Math.max(tickStep(start, stop, count2), 1));
...
function formatLocale(locale3) {
  ...
  function newFormat(specifier, formats2) {
    return function(date2) {
      var string = [], i3 = -1, j3 = 0, n3 = specifier.length, c5, pad2, format2;
      if (!(date2 instanceof Date)) date2 = /* @__PURE__ */ new Date(+date2);
      while (++i3 < n3) {
        if (specifier.charCodeAt(i3) === 37) {
          string.push(specifier.slice(j3, i3));
          if ((pad2 = pads[c5 = specifier.charAt(++i3)]) != null) c5 = specifier.charAt(++i3);
          else pad2 = c5 === "e" ? " " : "0";
          if (format2 = formats2[c5]) c5 = format2(date2, pad2);
          string.push(c5);
          j3 = i3 + 1;
        }
      }
  ...
  function parseSpecifier(d3, specifier, string, j3) {
    var i3 = 0, n3 = specifier.length, m4 = string.length, c5, parse;
    while (i3 < n3) {
      if (j3 >= m4) return -1;
      c5 = specifier.charCodeAt(i3++);
      if (c5 === 37) {
        c5 = specifier.charAt(i3++);
        parse = parses[c5 in pads ? specifier.charAt(i3++) : c5];
        if (!parse || (j3 = parse(d3, string, j3)) < 0) return -1;
      } else if (c5 != string.charCodeAt(j3++)) {
        return -1;
      }
    }
    return j3;
...
function colors_default(specifier) {
  var n3 = specifier.length / 6 | 0, colors = new Array(n3), i3 = 0;
  while (i3 < n3) colors[i3] = "#" + specifier.slice(i3 * 6, ++i3 * 6);
  return colors;
}
...
function sinebow_default(t6) {
  var x4;
  t6 = (0.5 - t6) * Math.PI;
  c2.r = 255 * (x4 = Math.sin(t6)) * x4;
  c2.g = 255 * (x4 = Math.sin(t6 + pi_1_3)) * x4;
  c2.b = 255 * (x4 = Math.sin(t6 + pi_2_3)) * x4;
  return c2 + "";
}
...
var Yr = (0, import_react.createContext)();
var Ar = function(e6) {
  var t6 = e6.children, n3 = e6.animate, i3 = void 0 === n3 || n3, o3 = e6.config, l3 = void 0 === o3 ? "default" : o3, a3 = (0, import_react.useMemo)(function() {
...
var Ur = function() {
  return (0, import_react.useContext)(Yr);
};
var Fr = function(e6) {
  var t6 = Ur(), o3 = t6.animate, l3 = t6.config, a3 = function(e7) {
    var r3 = (0, import_react.useRef)();
    return (0, import_react.useEffect)(function() {
      r3.current = e7;
    }, [e7]), r3.current;
  }(e6), d3 = (0, import_react.useMemo)(function() {
...
var wt = function(e6, t6, n3) {
  return void 0 === n3 && (n3 = {}), (0, import_react.useMemo)(function() {
    var r3 = jr({}, _t, n3);
...
var kt = function() {
  var e6 = (0, import_react.useRef)(null), r3 = (0, import_react.useState)({ left: 0, top: 0, width: 0, height: 0 }), t6 = r3[0], l3 = r3[1], a3 = (0, import_react.useState)(function() {
...
var Pt = function(e6) {
  ...
  return t6 ? (0, import_react.cloneElement)(n3, {}, r3) : r3;
};
...
var St = function(e6) {
  var r3 = e6.children, t6 = e6.theme, i3 = e6.renderWrapper, o3 = void 0 === i3 || i3, l3 = e6.isInteractive, a3 = void 0 === l3 || l3, d3 = e6.animate, s4 = e6.motionConfig, u3 = (0, import_react.useRef)(null);
...
var Lt = function(e6) {
  var t6 = e6.children, i3 = e6.theme, o3 = e6.isInteractive, l3 = void 0 === o3 || o3, d3 = e6.renderWrapper, s4 = void 0 === d3 || d3, u3 = e6.animate, c5 = e6.motionConfig, f3 = (0, import_react.useRef)(null), m4 = V(f3), y4 = m4.actions, v4 = m4.state, _ = (0, import_react.useCallback)(function(e7, r3) {
    return y4.showTooltipFromEvent(e7, r3);
  }, [y4.showTooltipFromEvent]), w3 = (0, import_react.useMemo)(function() {
    return { showTooltip: l3 ? _ : Bt, hideTooltip: l3 ? y4.hideTooltip : Bt };
  }, [y4.hideTooltip, l3, _]);
  return (0, import_jsx_runtime.jsx)(Wt, { theme: i3, children: (0, import_jsx_runtime.jsx)(Ar, { animate: u3, config: c5, children: (0, import_jsx_runtime.jsx)(j.Provider, { value: y4, children: (0, import_jsx_runtime.jsx)(O.Provider, { value: v4, children: (0, import_jsx_runtime.jsxs)(Pt, { condition: s4, wrapper: (0, import_jsx_runtime.jsx)("div", { style: Gt, ref: f3 }), children: [t6(w3), l3 && (0, import_jsx_runtime.jsx)(F, {})] }) }) }) }) });
};
...
var Ft = (0, import_react.memo)(function(e6) {
  var r3 = e6.id, t6 = e6.background, n3 = void 0 === t6 ? Ut.background : t6, i3 = e6.color, o3 = void 0 === i3 ? Ut.color : i3, l3 = e6.size, a3 = void 0 === l3 ? Ut.size : l3, d3 = e6.padding, s4 = void 0 === d3 ? Ut.padding : d3, u3 = e6.stagger, c5 = void 0 === u3 ? Ut.stagger : u3, f3 = a3 + s4, p3 = a3 / 2, h2 = s4 / 2;
  return true === c5 && (f3 = 2 * a3 + 2 * s4), (0, import_jsx_runtime.jsxs)("pattern", { id: r3, width: f3, height: f3, patternUnits: "userSpaceOnUse", children: [(0, import_jsx_runtime.jsx)("rect", { width: f3, height: f3, fill: n3 }), (0, import_jsx_runtime.jsx)("circle", { cx: h2 + p3, cy: h2 + p3, r: p3, fill: o3 }), c5 && (0, import_jsx_runtime.jsx)("circle", { cx: 1.5 * s4 + a3 + p3, cy: 1.5 * s4 + a3 + p3, r: p3, fill: o3 })] });
});
...
var on = (0, import_react.memo)(function(e6) {
  var r3 = e6.id, t6 = e6.spacing, n3 = void 0 === t6 ? nn.spacing : t6, i3 = e6.rotation, o3 = void 0 === i3 ? nn.rotation : i3, l3 = e6.background, a3 = void 0 === l3 ? nn.background : l3, d3 = e6.color, s4 = void 0 === d3 ? nn.color : d3, u3 = e6.lineWidth, c5 = void 0 === u3 ? nn.lineWidth : u3, f3 = Math.round(o3) % 360, p3 = Math.abs(n3);
  f3 > 180 ? f3 -= 360 : f3 > 90 ? f3 -= 180 : f3 < -180 ? f3 += 360 : f3 < -90 && (f3 += 180);
  var h2, g3 = p3, b3 = p3;
  return 0 === f3 ? h2 = "\n                M 0 0 L " + g3 + " 0\n                M 0 " + b3 + " L " + g3 + " " + b3 + "\n            " : 90 === f3 ? h2 = "\n                M 0 0 L 0 " + b3 + "\n                M " + g3 + " 0 L " + g3 + " " + b3 + "\n            " : (g3 = Math.abs(p3 / Math.sin(Kt(f3))), b3 = p3 / Math.sin(Kt(90 - f3)), h2 = f3 > 0 ? "\n                    M 0 " + -b3 + " L " + 2 * g3 + " " + b3 + "\n                    M " + -g3 + " " + -b3 + " L " + g3 + " " + b3 + "\n                    M " + -g3 + " 0 L " + g3 + " " + 2 * b3 + "\n                " : "\n                    M " + -g3 + " " + b3 + " L " + g3 + " " + -b3 + "\n                    M " + -g3 + " " + 2 * b3 + " L " + 2 * g3 + " " + -b3 + "\n                    M 0 " + 2 * b3 + " L " + 2 * g3 + " 0\n                "), (0, import_jsx_runtime.jsxs)("pattern", { id: r3, width: g3, height: b3, patternUnits: "userSpaceOnUse", children: [(0, import_jsx_runtime.jsx)("rect", { width: g3, height: b3, fill: a3, stroke: "rgba(255, 0, 0, 0.1)", strokeWidth: 0 }), (0, import_jsx_runtime.jsx)("path", { d: h2, strokeWidth: c5, stroke: s4, strokeLinecap: "square" })] });
});
...
var dn = (0, import_react.memo)(function(e6) {
  var r3 = e6.id, t6 = e6.color, n3 = void 0 === t6 ? an.color : t6, i3 = e6.background, o3 = void 0 === i3 ? an.background : i3, l3 = e6.size, a3 = void 0 === l3 ? an.size : l3, d3 = e6.padding, s4 = void 0 === d3 ? an.padding : d3, u3 = e6.stagger, c5 = void 0 === u3 ? an.stagger : u3, f3 = a3 + s4, p3 = s4 / 2;
  return true === c5 && (f3 = 2 * a3 + 2 * s4), (0, import_jsx_runtime.jsxs)("pattern", { id: r3, width: f3, height: f3, patternUnits: "userSpaceOnUse", children: [(0, import_jsx_runtime.jsx)("rect", { width: f3, height: f3, fill: o3 }), (0, import_jsx_runtime.jsx)("rect", { x: p3, y: p3, width: a3, height: a3, fill: n3 }), c5 && (0, import_jsx_runtime.jsx)("rect", { x: 1.5 * s4 + a3, y: 1.5 * s4 + a3, width: a3, height: a3, fill: n3 })] });
});
...
var pn = function(e6) {
  ...
  return !r3 || r3.length < 1 ? null : (0, import_jsx_runtime.jsx)("defs", { "aria-hidden": true, children: r3.map(function(e7) {
    ...
    return fn[r4] ? (0, import_react.createElement)(fn[r4], jr({ key: t6.id }, t6)) : null;
  }) });
};
...
var mn = (0, import_react.memo)(bn);
var yn = function(e6) {
  var r3 = e6.x, t6 = e6.y, n3 = e6.symbol, i3 = void 0 === n3 ? mn : n3, o3 = e6.size, l3 = e6.datum, a3 = e6.color, d3 = e6.borderWidth, u3 = e6.borderColor, c5 = e6.label, f3 = e6.labelTextAnchor, p3 = void 0 === f3 ? "middle" : f3, h2 = e6.labelYOffset, g3 = void 0 === h2 ? -12 : h2, b3 = zt(), m4 = Ur(), y4 = m4.animate, v4 = m4.config, _ = useSpring({ transform: "translate(" + r3 + ", " + t6 + ")", config: v4, immediate: !y4 });
  return (0, import_jsx_runtime.jsxs)(animated.g, { transform: _.transform, style: { pointerEvents: "none" }, children: [(0, import_react.createElement)(i3, { size: o3, color: a3, datum: l3, borderWidth: d3, borderColor: u3 }), c5 && (0, import_jsx_runtime.jsx)("text", { textAnchor: p3, y: g3, style: Mt(b3.dots.text), children: c5 })] });
};
...
var vn = (0, import_react.memo)(yn);
var _n = function(e6) {
  var r3 = e6.width, t6 = e6.height, n3 = e6.axis, i3 = e6.scale, o3 = e6.value, l3 = e6.lineStyle, a3 = e6.textStyle, d3 = e6.legend, s4 = e6.legendPosition, u3 = void 0 === s4 ? "top-right" : s4, c5 = e6.legendOffsetX, f3 = void 0 === c5 ? 14 : c5, p3 = e6.legendOffsetY, h2 = void 0 === p3 ? 14 : p3, g3 = e6.legendOrientation, b3 = void 0 === g3 ? "horizontal" : g3, m4 = zt(), y4 = 0, v4 = 0, _ = 0, w3 = 0;
  "y" === n3 ? (_ = i3(o3), v4 = r3) : (y4 = i3(o3), w3 = t6);
  var k4 = null;
  if (d3) {
    var R = function(e7) {
      var r4 = e7.axis, t7 = e7.width, n4 = e7.height, i4 = e7.position, o4 = e7.offsetX, l4 = e7.offsetY, a4 = e7.orientation, d4 = 0, s5 = 0, u4 = "vertical" === a4 ? -90 : 0, c6 = "start";
      if ("x" === r4) switch (i4) {
        case "top-left":
          d4 = -o4, s5 = l4, c6 = "end";
          break;
        case "top":
          s5 = -l4, c6 = "horizontal" === a4 ? "middle" : "start";
          break;
        case "top-right":
          d4 = o4, s5 = l4, c6 = "horizontal" === a4 ? "start" : "end";
          break;
        case "right":
          d4 = o4, s5 = n4 / 2, c6 = "horizontal" === a4 ? "start" : "middle";
          break;
        case "bottom-right":
          d4 = o4, s5 = n4 - l4, c6 = "start";
          break;
        case "bottom":
          s5 = n4 + l4, c6 = "horizontal" === a4 ? "middle" : "end";
          break;
        case "bottom-left":
          s5 = n4 - l4, d4 = -o4, c6 = "horizontal" === a4 ? "end" : "start";
          break;
        case "left":
          d4 = -o4, s5 = n4 / 2, c6 = "horizontal" === a4 ? "end" : "middle";
      }
      else switch (i4) {
        case "top-left":
          d4 = o4, s5 = -l4, c6 = "start";
          break;
        case "top":
          d4 = t7 / 2, s5 = -l4, c6 = "horizontal" === a4 ? "middle" : "start";
          break;
        case "top-right":
          d4 = t7 - o4, s5 = -l4, c6 = "horizontal" === a4 ? "end" : "start";
          break;
        case "right":
          d4 = t7 + o4, c6 = "horizontal" === a4 ? "start" : "middle";
          break;
        case "bottom-right":
          d4 = t7 - o4, s5 = l4, c6 = "end";
          break;
        case "bottom":
          d4 = t7 / 2, s5 = l4, c6 = "horizontal" === a4 ? "middle" : "end";
          break;
        case "bottom-left":
          d4 = o4, s5 = l4, c6 = "horizontal" === a4 ? "start" : "end";
          break;
        case "left":
          d4 = -o4, c6 = "horizontal" === a4 ? "end" : "middle";
      }
      return { x: d4, y: s5, rotation: u4, textAnchor: c6 };
...
var In = function(e6, r3, t6, n3) {
  var i3 = void 0 === n3 ? {} : n3, o3 = i3.dataKey, l3 = i3.colorKey, a3 = void 0 === l3 ? "color" : l3, d3 = i3.targetKey, s4 = void 0 === d3 ? "fill" : d3, u3 = [], c5 = {};
      ...
      if (Ln(d4, r4, o3)) {
        ...
        if (f3) {
          if (Gn.includes(f3.type)) if ("inherit" === f3.background || "inherit" === f3.color) {
            ...
            "inherit" === f3.background && (b3 = b3 + ".bg." + p3, h2 = p3), "inherit" === f3.color && (b3 = b3 + ".fg." + p3, g3 = p3), (0, import_set.default)(r4, s4, "url(#" + b3 + ")"), c5[b3] || (u3.push(jr({}, f3, { id: b3, background: h2, color: g3 })), c5[b3] = 1);
            ...
            if (f3.colors.map(function(e7) {
              ...
              w3.id = _, (0, import_set.default)(r4, s4, "url(#" + _ + ")"), c5[_] || (u3.push(w3), c5[_] = 1);
            } else (0, import_set.default)(r4, s4, "url(#" + l4 + ")");
          }
        }
        return "break";
...
var b = (0, import_react2.memo)(function(t6) {
  var o3, n3 = t6.position, r3 = t6.anchor, e6 = t6.children, l3 = zt(), d3 = Ur(), y4 = d3.animate, f3 = d3.config, b3 = kt(), g3 = b3[0], w3 = b3[1], T2 = (0, import_react2.useRef)(false), C4 = void 0, E3 = false, P2 = w3.width > 0 && w3.height > 0, j3 = Math.round(n3[0]), N2 = Math.round(n3[1]);
...
var g = (0, import_react2.memo)(function(t6) {
...
var w = (0, import_react2.memo)(function(t6) {
  var i3, o3 = t6.id, n3 = t6.value, r3 = t6.format, e6 = t6.enableChip, l3 = void 0 !== e6 && e6, a3 = t6.color, c5 = t6.renderContent, h2 = zt(), u3 = Ot(r3);
  if ("function" == typeof c5) i3 = c5();
  else {
    var f3 = n3;
...
var C3 = (0, import_react2.memo)(function(t6) {
...
var E2 = (0, import_react2.memo)(function(t6) {
  var i3 = t6.x0, n3 = t6.x1, r3 = t6.y0, e6 = t6.y1, l3 = zt(), u3 = Ur(), d3 = u3.animate, y4 = u3.config, f3 = (0, import_react2.useMemo)(function() {
...
var P = (0, import_react2.memo)(function(t6) {
...
var j = (0, import_react2.createContext)({ showTooltipAt: function() {
}, showTooltipFromEvent: function() {
}, hideTooltip: function() {
} });
var N = { isVisible: false, position: [null, null], content: null, anchor: null };
var O = (0, import_react2.createContext)(N);
var V = function(t6) {
  var i3 = (0, import_react2.useState)(N), n3 = i3[0], l3 = i3[1], a3 = (0, import_react2.useCallback)(function(t7, i4, o3) {
    var n4 = i4[0], r3 = i4[1];
    void 0 === o3 && (o3 = "top"), l3({ isVisible: true, position: [n4, r3], anchor: o3, content: t7 });
  }, [l3]), c5 = (0, import_react2.useCallback)(function(i4, o3, n4) {
    void 0 === n4 && (n4 = "top");
    var r3 = t6.current.getBoundingClientRect(), e6 = t6.current.offsetWidth, a4 = e6 === r3.width ? 1 : e6 / r3.width, c6 = "touches" in o3 ? o3.touches[0] : o3, s5 = c6.clientX, h2 = c6.clientY, u3 = (s5 - r3.left) * a4, d3 = (h2 - r3.top) * a4;
    "left" !== n4 && "right" !== n4 || (n4 = u3 < r3.width / 2 ? "right" : "left"), l3({ isVisible: true, position: [u3, d3], anchor: n4, content: i4 });
  }, [t6, l3]), s4 = (0, import_react2.useCallback)(function() {
    l3(N);
  }, [l3]);
  return { actions: (0, import_react2.useMemo)(function() {
    return { showTooltipAt: a3, showTooltipFromEvent: c5, hideTooltip: s4 };
  }, [a3, c5, s4]), state: n3 };
};
var k2 = function() {
  var t6 = (0, import_react2.useContext)(j);
  if (void 0 === t6) throw new Error("useTooltip must be used within a TooltipProvider");
  return t6;
};
var z2 = function() {
  var t6 = (0, import_react2.useContext)(O);
  ...
  if ((0, import_isPlainObject2.default)(e6)) {
    ...
    if (function(e7) {
      ...
      if (Ke(e6.scheme)) {
        ...
        var c5 = ordinal(Be[e6.scheme][e6.size || 9]), s4 = function(e7) {
          return c5(n3(e7));
        };
        return s4.scale = c5, s4;
      }
    }
...
var f2 = function(e6) {
  var i3 = e6.x, n3 = e6.y, o3 = e6.size, r3 = e6.fill, l3 = e6.opacity, a3 = void 0 === l3 ? 1 : l3, c5 = e6.borderWidth, d3 = void 0 === c5 ? 0 : c5, s4 = e6.borderColor;
...
var x3 = function(t6) {
  ...
  var c5 = "number" == typeof o3 ? { top: o3, right: o3, bottom: o3, left: o3 } : p2({}, k3, o3), d3 = c5.left + c5.right, s4 = c5.top + c5.bottom, h2 = l3 + d3, g3 = a3 + s4, f3 = (r3 - 1) * n3;
  return "row" === i3 ? h2 = l3 * r3 + f3 + d3 : "column" === i3 && (g3 = a3 * r3 + f3 + s4), { width: h2, height: g3, padding: c5 };
};
var b2 = function(t6) {
  var e6 = t6.anchor, i3 = t6.translateX, n3 = t6.translateY, o3 = t6.containerWidth, r3 = t6.containerHeight, l3 = t6.width, a3 = t6.height, c5 = i3, d3 = n3;
  switch (e6) {
    case "top":
      c5 += (o3 - l3) / 2;
      break;
    ...
    case "left":
      ...
      break;
    case "center":
      c5 += (o3 - l3) / 2, d3 += (r3 - a3) / 2;
  }
  return { x: c5, y: d3 };
};
var S = function(t6) {
  var e6, i3, n3, o3, r3, l3, a3 = t6.direction, c5 = t6.justify, d3 = t6.symbolSize, s4 = t6.symbolSpacing, h2 = t6.width, g3 = t6.height;
  switch (a3) {
    case "left-to-right":
      e6 = 0, i3 = (g3 - d3) / 2, o3 = g3 / 2, l3 = "central", c5 ? (n3 = h2, r3 = "end") : (n3 = d3 + s4, r3 = "start");
      break;
    case "right-to-left":
      e6 = h2 - d3, i3 = (g3 - d3) / 2, o3 = g3 / 2, l3 = "central", c5 ? (n3 = 0, r3 = "start") : (n3 = h2 - d3 - s4, r3 = "end");
      break;
    case "top-to-bottom":
      e6 = (h2 - d3) / 2, i3 = 0, n3 = h2 / 2, r3 = "middle", c5 ? (o3 = g3, l3 = "alphabetic") : (o3 = d3 + s4, l3 = "text-before-edge");
      break;
    case "bottom-to-top":
      e6 = (h2 - d3) / 2, i3 = g3 - d3, n3 = h2 / 2, r3 = "middle", c5 ? (o3 = 0, l3 = "text-before-edge") : (o3 = g3 - d3 - s4, l3 = "alphabetic");
  }
...
var X = function(i3) {
  var n3, l3, a3, d3, g3, f3, m4, v4, u3, y4, k4, x4 = i3.x, b3 = i3.y, A3 = i3.width, W2 = i3.height, z3 = i3.data, C4 = i3.direction, X2 = void 0 === C4 ? "left-to-right" : C4, Y2 = i3.justify, O4 = void 0 !== Y2 && Y2, B3 = i3.textColor, H2 = i3.background, E3 = void 0 === H2 ? "transparent" : H2, j3 = i3.opacity, L = void 0 === j3 ? 1 : j3, M2 = i3.symbolShape, F2 = void 0 === M2 ? "square" : M2, T2 = i3.symbolSize, P2 = void 0 === T2 ? 16 : T2, V2 = i3.symbolSpacing, R = void 0 === V2 ? 8 : V2, D2 = i3.symbolBorderWidth, q2 = void 0 === D2 ? 0 : D2, G = i3.symbolBorderColor, I = void 0 === G ? "transparent" : G, N2 = i3.onClick, _ = i3.onMouseEnter, J = i3.onMouseLeave, K2 = i3.toggleSerie, Q = i3.effects, U = (0, import_react4.useState)({}), Z = U[0], $ = U[1], tt2 = zt(), et2 = (0, import_react4.useCallback)(function(t6) {
    ...
    null == _ || _(z3, t6);
  }, [_, z3, Q]), it2 = (0, import_react4.useCallback)(function(t6) {
    if (Q) {
      var e6 = Q.filter(function(t7) {
        return "hover" !== t7.on;
      }).reduce(function(t7, e7) {
  ...
  }, onMouseEnter: et2, onMouseLeave: it2 }), c4.createElement(ht2, p2({ id: z3.id, x: ot2, y: rt2, size: null != (d3 = Z.symbolSize) ? d3 : P2, fill: null != (g3 = null != (f3 = z3.fill) ? f3 : z3.color) ? g3 : "black", borderWidth: null != (m4 = Z.symbolBorderWidth) ? m4 : q2, borderColor: null != (v4 = Z.symbolBorderColor) ? v4 : I }, z3.hidden ? tt2.legends.hidden.symbol : void 0)), (0, import_jsx_runtime3.jsx)("text", { textAnchor: ct2, style: p2({}, Mt(tt2.legends.text), { fill: null != (u3 = null != (y4 = null != (k4 = Z.itemTextColor) ? k4 : B3) ? y4 : tt2.legends.text.fill) ? u3 : "black", dominantBaseline: dt2, pointerEvents: "none", userSelect: "none" }, z3.hidden ? tt2.legends.hidden.text : void 0), x: lt2, y: at2, children: z3.label })] });
};
var Y = function(e6) {
  var i3 = e6.data, n3 = e6.x, o3 = e6.y, r3 = e6.direction, l3 = e6.padding, a3 = void 0 === l3 ? 0 : l3, c5 = e6.justify, d3 = e6.effects, s4 = e6.itemWidth, h2 = e6.itemHeight, g3 = e6.itemDirection, f3 = void 0 === g3 ? "left-to-right" : g3, m4 = e6.itemsSpacing, v4 = void 0 === m4 ? 0 : m4, u3 = e6.itemTextColor, p3 = e6.itemBackground, y4 = void 0 === p3 ? "transparent" : p3, k4 = e6.itemOpacity, b3 = void 0 === k4 ? 1 : k4, S2 = e6.symbolShape, A3 = e6.symbolSize, W2 = e6.symbolSpacing, z3 = e6.symbolBorderWidth, C4 = e6.symbolBorderColor, w3 = e6.onClick, Y2 = e6.onMouseEnter, O4 = e6.onMouseLeave, B3 = e6.toggleSerie, H2 = x3({ itemCount: i3.length, itemWidth: s4, itemHeight: h2, itemsSpacing: v4, direction: r3, padding: a3 }).padding, E3 = "row" === r3 ? s4 + v4 : 0, j3 = "column" === r3 ? h2 + v4 : 0;
  return (0, import_jsx_runtime3.jsx)("g", { transform: "translate(" + n3 + "," + o3 + ")", children: i3.map(function(e7, i4) {
    return (0, import_jsx_runtime3.jsx)(X, { data: e7, x: i4 * E3 + H2.left, y: i4 * j3 + H2.top, width: s4, height: h2, direction: f3, justify: c5, effects: d3, textColor: u3, background: y4, opacity: b3, symbolShape: S2, symbolSize: A3, symbolSpacing: W2, symbolBorderWidth: z3, symbolBorderColor: C4, onClick: w3, onMouseEnter: Y2, onMouseLeave: O4, toggleSerie: B3 }, i4);
  }) });
};
var O3 = function(e6) {
  var i3 = e6.data, n3 = e6.containerWidth, o3 = e6.containerHeight, r3 = e6.translateX, l3 = void 0 === r3 ? 0 : r3, a3 = e6.translateY, c5 = void 0 === a3 ? 0 : a3, d3 = e6.anchor, s4 = e6.direction, h2 = e6.padding, g3 = void 0 === h2 ? 0 : h2, f3 = e6.justify, m4 = e6.itemsSpacing, v4 = void 0 === m4 ? 0 : m4, u3 = e6.itemWidth, p3 = e6.itemHeight, y4 = e6.itemDirection, k4 = e6.itemTextColor, S2 = e6.itemBackground, A3 = e6.itemOpacity, W2 = e6.symbolShape, z3 = e6.symbolSize, C4 = e6.symbolSpacing, w3 = e6.symbolBorderWidth, X2 = e6.symbolBorderColor, O4 = e6.onClick, B3 = e6.onMouseEnter, H2 = e6.onMouseLeave, E3 = e6.toggleSerie, j3 = e6.effects, L = x3({ itemCount: i3.length, itemsSpacing: v4, itemWidth: u3, itemHeight: p3, direction: s4, padding: g3 }), M2 = L.width, F2 = L.height, T2 = b2({ anchor: d3, translateX: l3, translateY: c5, containerWidth: n3, containerHeight: o3, width: M2, height: F2 }), P2 = T2.x, V2 = T2.y;
...
var H = function(t6, e6) {
  var i3 = e6.data, n3 = e6.containerWidth, o3 = e6.containerHeight, r3 = e6.translateX, l3 = void 0 === r3 ? 0 : r3, a3 = e6.translateY, c5 = void 0 === a3 ? 0 : a3, d3 = e6.anchor, s4 = e6.direction, h2 = e6.padding, g3 = void 0 === h2 ? 0 : h2, f3 = e6.justify, m4 = void 0 !== f3 && f3, v4 = e6.itemsSpacing, u3 = void 0 === v4 ? 0 : v4, p3 = e6.itemWidth, y4 = e6.itemHeight, k4 = e6.itemDirection, A3 = void 0 === k4 ? "left-to-right" : k4, W2 = e6.itemTextColor, z3 = e6.symbolSize, C4 = void 0 === z3 ? 16 : z3, w3 = e6.symbolSpacing, X2 = void 0 === w3 ? 8 : w3, Y2 = e6.theme, O4 = x3({ itemCount: i3.length, itemWidth: p3, itemHeight: y4, itemsSpacing: u3, direction: s4, padding: g3 }), H2 = O4.width, E3 = O4.height, j3 = O4.padding, L = b2({ anchor: d3, translateX: l3, translateY: c5, containerWidth: n3, containerHeight: o3, width: H2, height: E3 }), M2 = L.x, F2 = L.y, T2 = "row" === s4 ? p3 + u3 : 0, P2 = "column" === s4 ? y4 + u3 : 0;
  t6.save(), t6.translate(M2, F2), t6.font = Y2.legends.text.fontSize + "px " + (Y2.legends.text.fontFamily || "sans-serif"), i3.forEach(function(e7, i4) {
    var n4, o4, r4 = i4 * T2 + j3.left, l4 = i4 * P2 + j3.top, a4 = S({ direction: A3, justify: m4, symbolSize: C4, symbolSpacing: X2, width: p3, height: y4 }), c6 = a4.symbolX, d4 = a4.symbolY, s5 = a4.labelX, h3 = a4.labelY, g4 = a4.labelAnchor, f4 = a4.labelAlignment;
    t6.fillStyle = null != (n4 = e7.color) ? n4 : "black", t6.fillRect(r4 + c6, l4 + d4, C4, C4), t6.textAlign = B2[g4], "central" === f4 && (t6.textBaseline = "middle"), t6.fillStyle = null != (o4 = null != W2 ? W2 : Y2.legends.text.fill) ? o4 : "black", t6.fillText(String(e7.label), r4 + s5, l4 + h3);
  }), t6.restore();
};
var j2 = function(t6) {
  var e6 = t6.scale, i3 = t6.domain, n3 = t6.reverse, o3 = void 0 !== n3 && n3, r3 = t6.valueFormat, l3 = void 0 === r3 ? function(t7) {
    return t7;
  } : r3, a3 = t6.separator, c5 = void 0 === a3 ? " - " : a3;
  return (0, import_react4.useMemo)(function() {
    var t7 = (null != i3 ? i3 : e6.range()).map(function(t8, i4) {
      ...
      return { id: t8, index: i4, extent: [o4, r4], label: "" + l3(o4) + c5 + l3(r4), value: e6(o4), color: t8 };
    });
...
//# sourceMappingURL=chunk-KTDZM2VH.js.map
