...
app.use(cors({
  origin: ["http://localhost:5173","http://localhost:5174","http://localhost:5175","https://intellistay-frontend.onrender.com","https://intellistay-admin.onrender.com","https://13.49.76.229","http://13.49.76.229","http://13.49.76.229:8000"],
  ...
  try {
    ...
    const completion = await openai.chat.completions.create({
      ...
      messages: [
        {
          role: "system",
          content: `You are IntelliStay's AI assistant, an expert in hotel and restaurant services. 
          Keep responses concise and friendly. Focus on:
          - Room bookings and types
...
app.post('/staff/rooms/confirmbook', pload.array('proofDocuments', 10), async (req, res) => {
  try {
    ...
    const checkOutDate = datas.checkOutDate;
    const totalAmount = totalRate;
    const userId = mongoose.Types.ObjectId("671cae6bdd15a1a7c1fe0e3b"); // Ensure the ID is a string and properly formatted
...
app.get('/todayLeaveCount', async (req, res) => {
